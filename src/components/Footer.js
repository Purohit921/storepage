...
const Footer = ({ footer, shop, retail, about, contact }) => {
  return (
    <>
      <div className="PreFooter">
        <div>
          ...
          <p>
            ...
            10-day replacementpolicy on mi.com{" "}
          </p>
        </div>
        <div>
          {shieldIcon}
      ...
      <div className="footer">
        <div>
          ...
          {footer.map((item, index) => (
            <a key={item.url} index={index} href={item.url}>
              {item.name}
            </a>
          ))}
        </div>
      ...
      <div className="footerBorder">
        Copyright © 2024 ASISH . All Rights Reserved
      </div>
    </>
  );
};
